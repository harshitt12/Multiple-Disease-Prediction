...
pickle1 = open("saved_models/diabetes_model.sav","rb")
pickle2 = open("saved_models/heart_disease_model.sav","rb")
pickle3 = open("saved_models/parkinsons_model.sav","rb")

diabetes_model = pickle.load(pickle1)

heart_disease_model = pickle.load(pickle2)

parkinsons_model = pickle.load(pickle3)
